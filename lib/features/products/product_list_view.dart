...
import '../../models/enums.dart' show ProductSort;
import '../../models/product.dart'
    show Product, productCategories, localizedCategoryLabel, categoryLabel;
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: SheetTitle(title: l10n.sortTitle),
                ),
                for (final (value, label) in [
                  (ProductSort.recentFirst, l10n.sortRecentFirst),
                  (ProductSort.nameAsc, l10n.sortNameAsc),
                  (ProductSort.bestPriceAsc, l10n.sortBestPriceAsc),
                  (ProductSort.bestPriceDesc, l10n.sortBestPriceDesc),
                ])
                  ListTile(
                    title: Text(label),
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: l10n.searchByNameStoreCat,
